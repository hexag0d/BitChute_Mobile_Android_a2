...
namespace com.xamarin.example.BitChute.Activities
{
    ...
    public class DiscoverClickListener : Java.Lang.Object, IOnClickListener
    {
        TabHost tabHost2;

        static int tbC = 0;

        public DiscoverClickListener(TabHost tabHost2)
        {
        ...
        public void OnClick(View v)
        {
            if (tabHost2.CurrentTab == 2)
            {
                ...
                WebView discoverWebView = tabHost2.CurrentView.FindViewById<WebView>(Resource.Id.webViewDiscover);

                if (tbC == 0)
                {
                    discoverWebView.Reload();
                ...
                {
                    discoverWebView.LoadUrl(@"https://bitchute.com/");
