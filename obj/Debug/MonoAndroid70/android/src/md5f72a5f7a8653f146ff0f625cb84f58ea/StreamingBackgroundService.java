package md5f72a5f7a8653f146ff0f625cb84f58ea;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BackgroundStreamingAudio.Services.StreamingBackgroundService, BitChute", StreamingBackgroundService.class, __md_methods);
	}
	...
	public StreamingBackgroundService ()
	{
		...
		if (getClass () == StreamingBackgroundService.class)
			mono.android.TypeManager.Activate ("BackgroundStreamingAudio.Services.StreamingBackgroundService, BitChute", "", this, new java.lang.Object[] {  });
	}
